...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden px-4 md:px-10 lg:px-14">
      {/* Background videos */}
      ...
      <nav className="relative z-10 flex items-center justify-between pt-6 md:pt-8">
        ...
        <motion.div
          className="hidden md:flex items-center gap-8 absolute left-[43%] -translate-x-1/2"
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          ...
          <button className="bg-white text-black text-sm font-semibold px-5 py-2 rounded-full hover:bg-white/90 transition-colors">
            Logga in
          </button>
        </motion.div>
      </nav>
      ...
      <div className="relative z-10 mt-auto pb-16 md:pb-24 flex flex-col md:flex-row md:items-end md:justify-between gap-8 md:gap-12">
        {/* Text — bottom left */}
        <div className="max-w-3xl">
          <motion.h1
            ...
            className="text-3xl md:text-5xl lg:text-6xl font-bold font-serif text-gradient-hero leading-tight mb-4">
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-primary-foreground max-w-xl leading-relaxed">
        ...
        <motion.div
          ...
          <div className="relative">
            <button className="flex items-center justify-between gap-6 bg-white text-[hsl(264,55%,46%)] px-8 py-5 rounded-full hover:bg-white/90 hover:shadow-2xl hover:shadow-white/20 hover:-translate-y-0.5 transition-all duration-300">
              <span className="text-xl font-bold whitespace-nowrap">Utforska dina möjligheter</span>
              <ArrowRight className="w-6 h-6 flex-shrink-0" />
            </button>
            <p className="absolute top-full left-1/2 -translate-x-1/2 mt-3 text-white/60 text-sm whitespace-nowrap">
              Det tar fem minuter
            </p>
          </div>
